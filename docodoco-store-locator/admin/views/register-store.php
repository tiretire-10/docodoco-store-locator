    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            <div class="col-8">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        <label for="inputLat" class="form-label">緯度 <span class="badge bg-danger">必須</span></label>
                        <input type="text" class="form-control" id="inputLat" name="lat" placeholder="35.63667739" value="<?php echo esc_attr(Helper::arr_get($data, 'lat')) ?>" required pattern="-?[0-9]{1,3}\.[0-9]{1,}">
                        <div class="form-error"><?php echo esc_html(Helper::arr_get($view_form_errors, 'lat')) ?></div>
                    </div>
                    <div class="col">
                        <label for="inputLng" class="form-label">経度 <span class="badge bg-danger">必須</span></label>
                        <input type="text" class="form-control" id="inputLng" name="lng" placeholder="139.7632321" value="<?php echo esc_attr(Helper::arr_get($data, 'lng')) ?>" required pattern="-?[0-9]{1,3}\.[0-9]{1,}">
